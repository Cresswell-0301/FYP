...
export default function ChatBox(){
    // Show Message Box
    const ShowMessage = () => {     // Something have changed
    ...
    const handleButtonClick = (value) => {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            if(i == value){
                ...
                if(i != 5 || i != 6){
                    Rpytxt.innerHTML = "Thank you for reaching out. To assist you better, pls select what " + button.textContent + " of issue that u need to ask.<br/><br/>Thank You !";
    ...
    const handleButtonClickSecond = (value) => {
        ...
        for (let x = 1; x <= 4; x++) {
            ...
            if(x == value) {
                ...
                switch(values) {
                    case "ProductInfo":
                        Rpytxt2.innerHTML = "Certainly! To get the newest product information about our latest phone models, features, and pricing.<br/><br/>" + Link;
                        break;

                    case "ProductDamage":
                        Rpytxt2.innerHTML = "Thank you for bringing this to our attention, and we're truly sorry for any inconvenience caused by the product damage😞😞.<br/><br/>To ensure we address this issue promptly, could you please provide more details, such as your order number and a brief description of the damage? Feel free to attach any photos you may have.<br/><br/>Additionally, we'd like to offer you the option to continue this conversation on Messenger for a more personalized and efficient resolution. Our team is ready to assist you further there.<br/><br/>" + Link + " to reach us at Messenger.";
                        break;

                    case "Return/Exchange":
                        Rpytxt2.innerHTML = "Thank you for reaching out to us. We're sorry to hear about the issue with your product, and we're here to assist you with the return or exchange process.<br/><br/>To initiate a return or exchange,<br/><br/><span style='font-weight: bold;'>Please prepare the following details:</span><br/><br/>1. Your order number.<br/><br/>2. A brief description of the reason for the return or exchange.<br/><br/>3. If applicable, attach photos of the product or the specific issue you've encountered.<br/><hr style = 'border-color: white; border-width: 0.25px; margin-top: 20px;'/><br/>Once you have this information ready, kindly send it to our team on Messenger. You can reach us by<br/><br/>" + Link + "<br/><br/>Our team will review your request and guide you through the next steps. If you have any additional questions or concerns, please don't hesitate to let us know. We appreciate your understanding, and we're committed to ensuring your satisfaction.";
                        break;

                    case "OrderDetails":
                        Rpytxt2.innerHTML = "Thank you for reaching out. We appreciate your inquiry about your order.<br/><br/>To assist you further, <span style='font-weight: bold;'>Please prepare the following details:</span><br/><br/>1. Your order number<br/><br/>To ensure a faster and more personalized response, we recommend continuing this conversation on our Messenger. Our customer service team is ready to assist you promptly. You can reach us on Messenger " + Link + ".<br/><br/>We appreciate your cooperation, and we look forward to assisting you on Messenger.";
                        break;

                    case "OrderStatus":
                        Rpytxt2.innerHTML = "Thank you for reaching out regarding your order. We understand the importance of staying updated on your purchase.<br/><br/>For a quicker and more personalized response, we recommend continuing this conversation on our Messenger. You can reach our customer services team there by " + Link + ".<br/><br/>Once you send us a message on Messenger with your order number, our team will promptly provide you with the latest information on your order status.<br/><br/>If you have any additional questions or concerns, please feel free to let us know. We're here to assist you.";
                        break;

                    case "PaymentMethod":
                        Rpytxt2.innerHTML = "We apologize for any inconvenience caused. Currently, our accepted payment methods include <span style='font-weight: bold;'>Credit Cards</span> & <span style='font-weight: bold;'>Debit Cards</span>.<br/><br/>However, we are exploring the possibility of adding more payment options in the future to enhance your shopping experience. If you have any specific preferences or suggestions, feel free to inform our team, and we will try our best to accommodate and assist you.<br/><br/>Additionally, if you have any further questions or concerns, feel free to drop a message in our Messenger ( " + Link + " ) for a quicker and more personalized response.";
                        break;

                    case "ContactUs":
                        Rpytxt2.innerHTML = "If you have any further questions, concerns, or would like to provide feedback, please feel free to contact our customer service team through Messenger. For a more immediate and personalized response, you can drop us a message at Messenger ( " + Link + " ). We appreciate your communication and look forward to assisting you.";
                        break;   

                    case "LiveChat":
                        Rpytxt2.innerHTML = "For real-time assistance, we recommend continuing this conversation on our Messenger Live Chat. You can reach our team there by " + Link + ".<br/><br/>For a more immediate and personalized response, feel free to connect with us. We appreciate your communication and look forward to assisting you further.";
                        break;  

                    case "Other":
                        Rpytxt2.innerHTML = "Please contact us on Messenger, and our team will do their best to assist you.<br/><br/>" + Link + " to get in touch. We appreciate your communication and are here to help !";
                        break;    
                ...
                <ContainerBox id="ContainerBox">
                    ...
                    <MessageBoxRight1>
                        ...
                        {[1, 2, 3, 4, 5, 6].map((buttonNumber) => (
                            <Btn1 key={`b${buttonNumber}`} id={`b${buttonNumber}`} onClick={() => handleButtonClick(buttonNumber)}></Btn1>
                        ))}
                        </div>
                    </MessageBoxRight1>
                    ...
                    <MessageBoxRight2>
                        ...
                        {[1, 2, 3, 4].map((buttonNumber2) => (
                            <Btn2 key={`bs${buttonNumber2}`} id={`bs${buttonNumber2}`} onClick={() => handleButtonClickSecond(buttonNumber2)}></Btn2>
                        ))}
                        </div>
                    </MessageBoxRight2>
